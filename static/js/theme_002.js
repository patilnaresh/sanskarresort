...
//==============================================
function royal_event_theme_scroll_actions() {
	"use strict";
...
//==============================================
function royal_event_theme_resize_actions() {
	"use strict";
...
//=====================================================
function royal_event_theme_sc_init(cont) {
	"use strict";
...
function royal_event_theme_init_post_formats() {
	...
	//if (ROYAL_EVENT_STORAGE['input_hover'])
	//	jQuery('form:not([class*="cp_cff_"]):not([class*="sc_input_hover_"])').addClass('sc_input_hover_'+ROYAL_EVENT_STORAGE['input_hover']);
