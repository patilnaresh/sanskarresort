...
function royal_event_ready_actions() {
	...
	ROYAL_EVENT_STORAGE['top_panel_height'] = 0;	//Math.max(0, jQuery('.top_panel_wrap').height());
...
function royal_event_scroll_actions() {
	...
	// Call theme specific action (if exists)
    //----------------------------------------------
	if (window.royal_event_theme_scroll_actions) royal_event_theme_scroll_actions();
...
function royal_event_resize_actions() {
	...
	// Call theme specific action (if exists)
    //----------------------------------------------
	if (window.royal_event_theme_resize_actions) royal_event_theme_resize_actions();
